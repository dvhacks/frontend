...
const AsyncBuyer = MyLoadable({ loader: () => import('./containers/Buyer/Buyer/ConnectedBuyer') });
const AsyncConfirmItem = MyLoadable({ loader: () => import('./containers/Buyer/Buyer/ConnectedConfirmItem') });
const AsyncItemConfirmed = MyLoadable({ loader: () => import('./containers/Buyer/Buyer/ConnectedItemConfirmed') });
...
const Routes = [
  ...
  <RestrictedRoute type='private' path="/buyer" exact component={AsyncBuyer} />,
  <RestrictedRoute type='private' path="/buyer/confirm-item" exact component={AsyncConfirmItem} />,
  <RestrictedRoute type='private' path="/buyer/item-confirmed" exact component={AsyncItemConfirmed} />
];
